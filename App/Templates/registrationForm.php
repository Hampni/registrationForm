...
<div class="main-w3layouts wrapper">
    ...
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/ru_RU/sdk.js#xfbml=1&version=v14.0" nonce="GGjbTgqU"></script>
...
gQmx2ZCwgTG9zIEFuZ2VsZXMsIENBIDkwMDI4LCDQodCo0JA!5e0!3m2!1sru!2slt!4v1658219330371!5m2!1sru!2slt" style="border:0; width: 100%; height: 450px" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    ...
    <div class="main-agileinfo">
        <div class="agileits-top" id="agileits-top-first">
            ...
            <form id="first-form" class="first-form">
                ...
                <!--First name-->
                <label style="color: floralwhite; font-size: 14px; font-weight: 100" class="label_input" id="first_name_label" for="first_name">Only upper and lower case: Jhon</label>
                <input class="text email" style="margin-top: 5px;" type="text" id="first_name" name="first_name" placeholder="First name" required="">
                ...
                <input class="text email" style="margin-top: 5px;" type="text" id="last_name" name="last_name" placeholder="Last name" required="">
                ...
                <input class="text email" style="margin-top: 5px;" type="text" id="birthday" name="birthday" placeholder="Birthday" required="">
                ...
                <input class="text email" style="margin-top: 5px;" type="text" id="report_subject" name="report_subject" placeholder="Report subject" required="">

                <!--Country-->
                <label style="color: floralwhite; font-size: 14px; font-weight: 100" id="country_label" for="country">Choose
                    your country:</label>
                <select class="browser-default custom-select" style="margin-top: 5px; margin-bottom: 25px;" id="country" name="country" required="required">
                ...
                <input class="text email" style="margin-top: 5px; display: block" id="phone" type="text" name="phone" placeholder="Phone" required="">
                <br>
                <!--Email-->
                ...
                <input class="text email" style="margin-top: 5px;" type="email" id="email" name="email" placeholder="Email" required="">
        ...
        <div class="agileits-top-second" id="agileits-top-second">
            ...
            <form class="second-form" id="second-form">
                ...
                <textarea class="form-control" name="about_me" placeholder="About me" id="about_me" rows="4"></textarea>
                <label style="padding-top: 10px; color: white" for="formFileLg" class="form-label">Photo:</label>
                <input style="background: white; color: black" class="form-control form-control-lg" id="formFileLg" name="image" type="file" accept=".jpg,.png,.jpeg">
                <input type="submit" value="Next">
            </form>
        </div>
        <div class="agileits-top-third" id="agileits-top-third">
            ...
            <div style="padding:25px">
                <div>
                    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fprodanets.trainee.albedo.dev%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">
                ...
                <!--Twitter-->
                <div>
                    <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" target="_blank" data-size="large" data-text="Check out this Meetup with SoCal AngularJS! " data-url="http://localhost:8002/" data-show-count="false">
